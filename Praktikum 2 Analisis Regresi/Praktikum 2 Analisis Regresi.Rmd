...
data <- read_excel("C:\\Users\\62878\\Downloads\\NSC-2025.xlsx", sheet="Sheet2")
...
$$\hat{Y} = 84.25520   -0.93772 X_1$$

dengan Y adalah indeks pembangunan manusia dan X3 adalah persentase penduduk miskin.

Didapatkan nilai $\hat\beta_0 = 84.25520$ artinya nilai dugaan rataan indeks pembangunan manusia ketika presentase penduduk miskin bernilai 0 persen adalah 84.25%, akan tetapi nilai 0 tidak ada dalam selang pengamatan presentase penduduk miskin sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_0 = 0.937728$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika presentase penduduk miskin berubah satu tahun adalah sebesar -0,937%

Koefisien determinasi yang dihasilkan adalah 0.8884 atau 88.84% artinya keragaman persentase penduduk miskin yang dapat dijelaskan oleh persentase indeks pembangunan manusia adalah sebesar 88.84%, sisanya yaitu 11.16% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
